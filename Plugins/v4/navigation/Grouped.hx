...
class Grouped extends NavigationBase implements NavigationInterface {
	...
	public function new (mouseArea:RCRectangle) {
		alignmentNavigation = Preferences.stringForKey ("alignment_navigation");
		super( mouseArea );
	}
...
/*		addLeftButton( false );
		...
		background = new RCRectangle (0, 0, this.width+40, this.height+20, colorBackground, .9, Config.ROUNDNESS);
