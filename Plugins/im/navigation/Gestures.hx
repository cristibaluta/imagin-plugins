...
/*		colorBackground = IMPreferences.hexColorForKey ("color_background_menu");
		colorArrow = IMPreferences.hexColorForKey ("color_arrow");
		colorArrowOver = IMPreferences.hexColorForKey ("color_highlighted");*/
	}
